...
**  Last updated:     vineri 25 mai 2015, 22:19:13 +0300
**
...
**	- After an empty declaration you should put semicolons !!!
**	ex - line 64,65 - the second constructor
**	After the braces of a functions body you don't put semicolons, do you?
**
*******************************************************************************
******************************************************************************/
...
private:
	...
	// this will be private to the class - accessible only by the c members
	// implicitly inline
