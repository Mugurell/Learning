...
// this will return true if the file doesn't contain any single character
// also returns true if the file can't be opened, but in that case we want
// to print another appropriate message.
bool
