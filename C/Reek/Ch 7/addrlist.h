...
**
** 		Maximum lenght of the various data (includes space for the
** 	 	terminating NUL byte), and maximum number of addresses.
*/
#define 	NAME_LENGHT		 30		/* longest name allowed */
#define 	ADDR_LENGHT		100		/* longest address allowed */
#define 	PHONE_LENGHT	 11		/* longest phone # allowed */
