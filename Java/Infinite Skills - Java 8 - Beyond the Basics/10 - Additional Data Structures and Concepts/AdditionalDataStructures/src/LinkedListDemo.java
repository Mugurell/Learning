...
public class LinkedListDemo
{
    public void showOperations() {
        ...
        while (litrInts.hasNext()) {
            ...
            litrInts.set(x * 2);    // replaces the last element returned by next/previous with the supplied argument
        }
        litrInts = myNumbers.listIterator(4);   // get an iterator to the 4th element
        litrInts.next();                        // get the element at the next position
        litrInts.add(252525);                   // replace it with the supplied argument
