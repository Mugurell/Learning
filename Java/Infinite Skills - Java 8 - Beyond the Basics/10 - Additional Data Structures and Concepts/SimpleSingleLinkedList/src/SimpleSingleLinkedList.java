...
public class SimpleSingleLinkedList<E> implements Iterable
{
    ...
    /**
     * Create a new DataLink and place it at the requested index.
     * @param index  index at which a newly constructed DataLink to be added.
     * @param data  value to be stored in the 'data' field of the new DataLink.
     */
    public void addAtIndex(int index, E data) {
        //can actually add at size since it would be the tail DataLink
        ...
        if (size == 0) {
            ...
            //find the link at index and it's next link to insert in the middle
    ...
    private class DataLink<E>
    {
        ...
        /**
         * Create a new DataLink and place it after the DataLink argument.
         * @param theData  value for the data field
         * @param previousLink  DataLink node to which to append the newly constructed - this DataLink
         */
