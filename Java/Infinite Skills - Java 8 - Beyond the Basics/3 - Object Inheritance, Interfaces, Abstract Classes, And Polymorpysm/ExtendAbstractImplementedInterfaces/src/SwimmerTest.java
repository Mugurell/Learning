...
public class SwimmerTest {
    ...
    public void testConstructors() throws Exception {
        ...
        Swimmer s2 = new Swimmer(racerID, name, age);
        assertNotNull("Could not create complex Swimmer", s2);
        assertEquals("Id is not set as expected on complex constructor", racerID, s2.getRacerID());
        assertEquals("Name not set as expected on complex constructor", name, s2.getName());
        assertEquals("Age not set as expected on complex constructor", age, s2.getAge());
    }
