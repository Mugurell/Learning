        ...
        while (!completedEntries) {
            ...
            switch (choice) {
                ...
                case 7:
                    if (checkRaceCreated()) {
                        // save racers to file
                        boolean success = populateAndStoreRaceManager.writeAthletesToFile(
                ...
                case 8:
                    if (checkRaceCreated()) {
                        ...
                        _race.setRacersList(populateAndStoreRaceManager.getAthletesFromFile(dataFile.dataFilePath));
                    }
                    break;
                case 9:
                default:
