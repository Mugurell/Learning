...
public class Runner extends Athlete implements Serializable
{
    ...
    /**
     * Get the data String for the Runner
     * @return String to match: RUNNER|name=someString;...;shoes=someString
     */
    public String toDataString() {
        return String.format("RUNNER|%shoes=%s",
                             super.toDataString(), getShoeBrand());
    }
}
