...
// By implementing Serializable we gain the ability to save the entire System.
// But for this, we are obliged to make sure everything inside of Race must also be serializable!
public class Race implements RaceManager, Serializable
{
     ...
     * @param name the athlete to remove
     */
     ...
     * @return the current racers list.
     */
     ...
     * @param racers  the racers with which the current list of racers will be populated.
     */
