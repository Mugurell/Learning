...
public class DBManager
{
     ...
     * @param connector  connections Behavior
     */
     ...
     * @param connector  connectionBehavior
    ...
    /**
     * Query if the table exists by looking if the what we're looking for in the table matches the column name and if
     * the value in that column matches.
     * @param query
     * @param col_name
     * @return
     */
